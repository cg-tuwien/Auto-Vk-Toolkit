...
* A [Vulkan 1.2 SDK from LunarG](https://vulkan.lunarg.com/sdk/home), optimally Vulkan SDK 1.2.141.0 or newer     
  **_Attention: SDKs 1.2.189.x are currently _incompatible_.** A fix that reestablishes compatibility can be expected until October 11, 2021.      
  For now, please use older SDKs. The recommended SDK is 1.2.182.0 for the moment.
