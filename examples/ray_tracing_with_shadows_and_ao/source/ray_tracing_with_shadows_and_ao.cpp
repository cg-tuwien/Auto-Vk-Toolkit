...
class ray_tracing_with_shadows_and_ao_invokee : public avk::invokee
{
...
int main() // <== Starting point ==
{
	...
	try {
		...
		auto mainWnd = avk::context().create_window("Real-Time Ray Tracing with Shadows and AO - Main Window");
