...
{
	template<> struct hash<gvk::material_gpu_data_ext>
	{
		std::size_t operator()(gvk::material_gpu_data_ext const& o) const noexcept
		{
			std::size_t h = 0;
			avk::hash_combine(h,
				static_cast<const gvk::material_gpu_data&>(o),
				o.mDiffuseTexUvSet,
				o.mSpecularTexUvSet,
				o.mAmbientTexUvSet,
				o.mEmissiveTexUvSet,
