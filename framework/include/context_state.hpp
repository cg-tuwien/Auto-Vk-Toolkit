...
namespace xk
{
	enum struct context_state
	{
		...
		anytime_during_or_after_init = initialization_begun | physical_device_selected | surfaces_created | device_created | queues_created | fully_initialized,
