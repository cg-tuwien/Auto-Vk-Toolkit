...
{
	template<> struct hash<gvk::swapchain_additional_attachments_changed_event>
	{
		std::size_t operator()(gvk::swapchain_additional_attachments_changed_event const& o) const noexcept
		{
			std::size_t h = 0;
