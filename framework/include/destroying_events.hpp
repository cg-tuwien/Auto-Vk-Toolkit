...
{
	template<> struct hash<gvk::destroying_graphics_pipeline_event>
	{
		std::size_t operator()(gvk::destroying_graphics_pipeline_event const& o) const noexcept
		{
			std::size_t h = 0;
	...
	template<> struct hash<gvk::destroying_compute_pipeline_event>
	{
		std::size_t operator()(gvk::destroying_compute_pipeline_event const& o) const noexcept
		{
			std::size_t h = 0;
	...
	template<> struct hash<gvk::destroying_ray_tracing_pipeline_event>
	{
		std::size_t operator()(gvk::destroying_ray_tracing_pipeline_event const& o) const noexcept
		{
			std::size_t h = 0;
			avk::hash_combine(h, std::string("destroying_graphics_pipeline_event"));
			return h;
	...
	template<> struct hash<gvk::destroying_image_event>
	{
		std::size_t operator()(gvk::destroying_image_event const& o) const noexcept
		{
			std::size_t h = 0;
	...
	template<> struct hash<gvk::destroying_image_view_event>
	{
		std::size_t operator()(gvk::destroying_image_view_event const& o) const noexcept
		{
			std::size_t h = 0;
