...
namespace gvk
{
	...
	#define LOG_ERROR___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "ERR:  ", msg), gvk::log_type::error, gvk::log_importance::normal })
	#define LOG_ERROR_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "ERR:  ", msg), gvk::log_type::error, gvk::log_importance::important })
	#else
	...
	#define LOG_WARNING___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "WARN: ", msg), gvk::log_type::warning, gvk::log_importance::normal })
	#define LOG_WARNING_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "WARN: ", msg), gvk::log_type::warning, gvk::log_importance::important })
	#else 
	...
	#define LOG_INFO___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "INFO: ", msg), gvk::log_type::info, gvk::log_importance::normal })
	#define LOG_INFO_EM___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "INFO: ", msg), gvk::log_type::info, gvk::log_importance::important })
	#else
	#define LOG_INFO(msg)
	...
	#define LOG_VERBOSE___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "VRBS: ", msg), gvk::log_type::verbose, gvk::log_importance::normal })
	#define LOG_VERBOSE_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "VRBS: ", msg), gvk::log_type::verbose, gvk::log_importance::important })
	#else 
	...
	#define LOG_MEGA_VERBOSE___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "MVRBS:", msg), gvk::log_type::verbose, gvk::log_importance::normal })
	#define LOG_MEGA_VERBOSE_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "MVRBS:", msg), gvk::log_type::verbose, gvk::log_importance::important })
	#else 
	...
	#define LOG_DEBUG___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG:  ", msg), gvk::log_type::debug, gvk::log_importance::normal })
	#define LOG_DEBUG_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG:  ", msg), gvk::log_type::debug, gvk::log_importance::important })
	#else
	...
	#define LOG_DEBUG_VERBOSE___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG-V:", msg), gvk::log_type::debug_verbose, gvk::log_importance::normal })
	#define LOG_DEBUG_VERBOSE_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG-V:", msg), gvk::log_type::debug_verbose, gvk::log_importance::important })
	#else
	...
	#define LOG_DEBUG_MEGA_VERBOSE___(msg)		gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG-MV:", msg), gvk::log_type::debug_verbose, gvk::log_importance::normal })
	#define LOG_DEBUG_MEGA_VERBOSE_EM___(msg)	gvk::dispatch_log(gvk::log_pack{ fmt::format("{}{}\n", "DBG-MV:", msg), gvk::log_type::debug_verbose, gvk::log_importance::important })
	#else
