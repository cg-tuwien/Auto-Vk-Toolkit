...
namespace cgb
{
	enum struct memory_access
	{
		...
		any_graphics_fundamental_write_access		= color_attachment_write_access | depth_stencil_attachment_write_access,
		any_graphics_extended_write_access			= any_graphics_fundamental_write_access | shader_buffers_and_images_write_access | transform_feedback_write_access | transform_feedback_counter_write_access,
